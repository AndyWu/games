...
- Weather changes every so often (shown in the top-left HUD), also derived from the system clock so it's the same for everyone: Sunny (50% of the time), Cloudy (15%), Rainy (20%), Rainstorm (10%), or a Heavy Thunderstorm (5%) with lightning flashes and thunder. Worse weather dims the lighting and shortens how far you can see.
