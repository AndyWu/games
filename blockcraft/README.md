...
- 2 Giant Eagles soar much higher and range much further than the regular birds — the same bird model, just scaled up to a real wingspan. Roughly once an in-game day, each one hunts down whichever bird or fish happens to be nearest it at the time and eats it outright — that kill is the eagle's alone, so unlike hunting one yourself it drops no Meat. They're attackable like every other creature here and worth 3 Meat if you take one down (4 HP, tougher than a regular bird).
